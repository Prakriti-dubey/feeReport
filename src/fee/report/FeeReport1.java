 ...
 * @author prakriti
 */
public class FeeReport1 extends javax.swing.JFrame {

    /**
     * Creates new form FeeReport1
     */
    public FeeReport1() {
        initComponents();
    }
 ...
 String test[]={"test"};
        Accountantlogin.main(test);
        this.dispose();        // TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String Test[]={"Test"};
        AdminLogin.main(Test);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FeeReport1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FeeReport1().setVisible(true);
            }
        });
    }
